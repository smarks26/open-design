...
export const en: Dict = {
  ...
  'updater.openInstaller': 'Install and quit',
  ...
  'updater.readyGeneric': 'A new version is ready. Click Install and quit to close Open Design and open the installer.',
  'updater.readyVersion': 'Open Design {version} is ready. Click Install and quit to close Open Design and open the installer.',
