...
export const ko: Dict = {
  ...
  'updater.readyGeneric': '새 버전이 준비되었습니다. 설치하고 종료를 클릭하면 Open Design을 닫고 설치 프로그램을 엽니다.',
  'updater.readyVersion': 'Open Design {version}이 준비되었습니다. 설치하고 종료를 클릭하면 Open Design을 닫고 설치 프로그램을 엽니다.',
