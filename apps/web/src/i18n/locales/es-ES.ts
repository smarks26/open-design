...
export const esES: Dict = {
  ...
  'updater.openInstaller': 'Instalar y salir',
  ...
  'updater.readyGeneric': 'Hay una nueva versión lista. Haz clic en Instalar y salir para cerrar Open Design y abrir el instalador.',
  'updater.readyVersion': 'Open Design {version} está listo. Haz clic en Instalar y salir para cerrar Open Design y abrir el instalador.',
