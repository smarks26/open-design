...
export const ru: Dict = {
  ...
  'updater.openInstaller': 'Установить и выйти',
  ...
  'updater.readyGeneric': 'Новая версия готова. Нажмите Установить и выйти, чтобы закрыть Open Design и открыть установщик.',
  'updater.readyVersion': 'Open Design {version} готов. Нажмите Установить и выйти, чтобы закрыть Open Design и открыть установщик.',
