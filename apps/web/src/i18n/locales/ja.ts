...
export const ja: Dict = {
  ...
  'updater.openInstaller': 'インストールして終了',
  ...
  'updater.readyGeneric': '新しいバージョンの準備ができました。インストールして終了をクリックすると、Open Design を閉じてインストーラーを開きます。',
  'updater.readyVersion': 'Open Design {version} の準備ができました。インストールして終了をクリックすると、Open Design を閉じてインストーラーを開きます。',
