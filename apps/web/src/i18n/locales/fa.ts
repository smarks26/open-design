...
export const fa: Dict = {
  ...
  'updater.openInstaller': 'نصب و خروج',
  ...
  'updater.readyGeneric': 'نسخه جدید آماده است. برای بستن Open Design و باز کردن نصب‌کننده، روی نصب و خروج کلیک کنید.',
  'updater.readyVersion': 'Open Design {version} آماده است. برای بستن Open Design و باز کردن نصب‌کننده، روی نصب و خروج کلیک کنید.',
