...
export const zhTW: Dict = {
  ...
  'updater.ready': '更新已就緒',
  'updater.readyGeneric': '新版本已就緒。點擊「安裝並結束」會關閉 Open Design 並開啟安裝器。',
  'updater.readyVersion': 'Open Design {version} 已就緒。點擊「安裝並結束」會關閉 Open Design 並開啟安裝器。',
