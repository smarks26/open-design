...
export const zhCN: Dict = {
  ...
  'updater.ready': '更新已就绪',
  'updater.readyGeneric': '新版本已就绪。点击“安装并退出”会关闭 Open Design 并打开安装器。',
  'updater.readyVersion': 'Open Design {version} 已就绪。点击“安装并退出”会关闭 Open Design 并打开安装器。',
