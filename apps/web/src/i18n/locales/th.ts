...
export const th: Dict = {
  ...
  'updater.openInstaller': 'ติดตั้งและออก',
  ...
  'updater.readyGeneric': 'เวอร์ชันใหม่พร้อมแล้ว คลิกติดตั้งและออกเพื่อปิด Open Design และเปิดตัวติดตั้ง',
  'updater.readyVersion': 'Open Design {version} พร้อมแล้ว คลิกติดตั้งและออกเพื่อปิด Open Design และเปิดตัวติดตั้ง',
