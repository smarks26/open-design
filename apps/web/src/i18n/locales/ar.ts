...
export const ar: Dict = {
  ...
  'updater.openInstaller': 'التثبيت والإنهاء',
  ...
  'updater.readyGeneric': 'إصدار جديد جاهز. انقر على التثبيت والإنهاء لإغلاق Open Design وفتح المثبت.',
  'updater.readyVersion': 'Open Design {version} جاهز. انقر على التثبيت والإنهاء لإغلاق Open Design وفتح المثبت.',
