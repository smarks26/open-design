...
export const it: Dict = {
  ...
  'updater.openInstaller': 'Installa ed esci',
  ...
  'updater.readyGeneric': 'È pronta una nuova versione. Fai clic su Installa ed esci per chiudere Open Design e aprire il programma di installazione.',
  'updater.readyVersion': 'Open Design {version} è pronto. Fai clic su Installa ed esci per chiudere Open Design e aprire il programma di installazione.',
